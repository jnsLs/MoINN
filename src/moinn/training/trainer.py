        ...
        try:
            for _ in range(n_epochs):
                ...
                for train_batch in train_iter:
                    ...
                    loss = self.loss_fn(train_batch, result, self.epoch)
                    loss.backward()
                    self.optimizer.step()
                    self.step += 1
                ...
                if self.epoch % self.validation_interval == 0 or self._stop:
                    ...
                    for val_batch in self.validation_loader:
                        ...
                        val_batch_loss = (
                            self.loss_fn(val_batch, val_result, 1e6).data.cpu().numpy()
                        )
                    ...
                    if self.best_loss > val_loss:
                        ...
                        chkpt = os.path.join(self.model_path, "best_model_state_dict")
                        torch.save(self.state_dict, chkpt)
